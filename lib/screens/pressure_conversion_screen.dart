...
class PressureConversionScreen extends StatefulWidget {
  static const routeName = '/pressure-conversion-screen';
  const PressureConversionScreen({Key? key}) : super(key: key);
...
class _PressureConversionScreenState extends State<PressureConversionScreen> {
                ...
                children: [
                  FieldListTile(
                    ...
                    child: ListView.builder(
                      itemCount: _pressureList.length,
  ...
  void convert({
    ...
    var result = (amount / _pressureList[from].rate) * _pressureList[to].rate;
    setState(() {
      if (_isFirstField) {
