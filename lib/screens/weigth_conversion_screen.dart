              ...
              child: Column(
                children: [
                  FieldListTile(
                    ...
                    title: _weightList[_firstFieldIndex].name,
                    subtitle: _weightList[_firstFieldIndex].id,
                  ...
                  FieldListTile(
                    ...
                    title: _weightList[_secondFieldIndex].name,
                    subtitle: _weightList[_secondFieldIndex].id,
                    bottomSheetHeader: "Select Unit",
                    onTappingField: () {
                      setState(() {
